...
const platformLinks = [
  {
    name: "YouTube",
    href: "https://www.youtube.com/playlist?list=PL-RK8UwXSeaoDwy7RZmpSrAj5AQirm0Fw",
    icon: (
  ...
  {
    name: "Spotify",
    href: "https://open.spotify.com/show/2THaWIyoL0G8CoMupHehZr",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[16px] leading-6 tracking-[-0.8px] text-gray-700 max-w-[520px]">
                The founder&apos;s journey, seen differently. Real conversations
                with design-minded founders about the product decisions that
                matter: MVP trade-offs, growth bottlenecks, AI workflows, and
                the thinking behind what actually gets built.
              </p>
