...
const platformLinks = [
  {
    name: "YouTube",
    href: "https://www.youtube.com/playlist?list=PL-RK8UwXSearlJdaf38IARoUhXeGWQoAL",
    icon: (
  ...
  {
    name: "Spotify",
    href: "https://open.spotify.com/show/4OoASKWSTlsdb2nCQ8BaeQ",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Apple Podcasts",
    href: "https://podcasts.apple.com/nz/podcast/bear-academy/id1536234805",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[16px] leading-6 tracking-[-0.8px] text-gray-700 max-w-[520px]">
                Candid conversations with founders, designers, and builders
                about the decisions behind what actually ships. Product bets,
                design craft, AI workflows, and the messy middle of turning an
                idea into something people use. Hosted by Bear Liu.
              </p>
