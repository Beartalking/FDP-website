...
- To re-port/add a teardown: `node scripts/port-teardown.mjs --report "<vault path>" --slug <slug> --date <YYYY-MM-DD> --tags "teardown,..."` then commit. (Apple Health #5 was published manually 2026-06-08, not via the porter — it had generated figures + inline links; see the dated record at the top of RESUME HERE.)
